...
public enum ModArmorMaterial implements IArmorMaterial {
    LUMINITE("luminite", 20, new int[]{4,5,7,4}, 30, SoundEvents.ITEM_ARMOR_EQUIP_GOLD,
            1.0F, 0,
            () -> {return Ingredient.fromItems(ModItems.LUMINITE_CRYSTAL.get());
    });
    ...
    public String getName() {
        return KursaDarbs.MOD_ID +":"+ this.name;
    }
